...
class AddItemFragment : Fragment() {
    ...
    private val viewModel: ListaCompraViewModel by activityViewModels<ListaCompraViewModel> {
        ListaCompraViewModelFactory(
            (activity?.application as ListaComprasApplication).database.itemDao()
        )
    }
...
//    private fun entradaValida() : Boolean{
